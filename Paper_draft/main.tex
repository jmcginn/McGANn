...
\begin{figure}
    ...
    \caption{Examples of \ac{GW} burst signals generated by a conditional generative adversarial network. Top row shows
examples from the training set. By row: Sine-Gaussian, Ringdown,
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/generations/interp_rd-sg.png}
    \includegraphics[width=\textwidth]{figures/generations/interp_wnb-blip.png}
...
\subsection{Sampling from simplex section}
